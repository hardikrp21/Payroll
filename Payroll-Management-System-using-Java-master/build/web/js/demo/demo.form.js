(function(a){
    a(document).ready(function(d){
        if(a.fn.autocomplete){
            ...
            if(a.fn.ColorPicker){
            a("#da-ex-colorpicker").ColorPicker({
                onSubmit:function(e,i,g,h){
                    a(h).val(i);
                    a(h).ColorPickerHide()
                    },
    ...
    for(var f in c){
        a("#da-ex-"+f).spinner(c[f])
        }
    }
    if(a.fn.elastic){
    a("#da-ex-elastic").elastic()
    }
    if(a.fn.elrte){
    var c={
        cssClass:"el-rte",
        ...
        fmAllow:true,
        fmOpen:function(e){
            a('<div id="myelfinder"></div>').elfinder({
